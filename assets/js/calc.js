...
const MAP_CONFIG = {
  enabled: false, // Начинаем без карт
  provider: 'static', // 'static', '2gis', 'yandex', 'google'
  fallbackMode: 'database' // Используем базу расстояний
};
...
class SmartLogisticsCalculator {
  ...
  initCityAutocomplete() {
    // Расширенный список городов России
    const cities = [
      // Федеральные центры
      'Москва', 'Санкт-Петербург',
      
      // Центральный ФО
      'Воронеж', 'Ярославль', 'Рязань', 'Тула', 'Тверь', 'Калуга', 'Владимир', 
      'Иваново', 'Кострома', 'Курск', 'Липецк', 'Орёл', 'Белгород', 'Брянск', 
      'Смоленск', 'Тамбов',
      
      // Приволжский ФО
      'Нижний Новгород', 'Казань', 'Самара', 'Уфа', 'Пермь', 'Саратов', 
      'Волгоград', 'Ижевск', 'Ульяновск', 'Тольятти', 'Оренбург', 'Пенза',
      'Киров', 'Чебоксары', 'Йошкар-Ола', 'Саранск', 'Стерлитамак',
      
      // Северо-Западный ФО
      'Архангельск', 'Мурманск', 'Калининград', 'Великий Новгород', 'Псков',
      'Петрозаводск', 'Вологда', 'Череповец', 'Сыктывкар',
      
      // Южный ФО и СКФО
      'Ростов-на-Дону', 'Краснодар', 'Волгоград', 'Астрахань', 'Сочи',
      'Ставрополь', 'Махачкала', 'Грозный', 'Владикавказ', 'Нальчик',
      
      // Уральский ФО
      'Екатеринбург', 'Челябинск', 'Тюмень', 'Магнитогорск', 'Нижний Тагил',
      'Курган', 'Сургут', 'Нижневартовск', 'Ноябрьск', 'Салехард',
      
      // Сибирский ФО
      'Новосибирск', 'Омск', 'Красноярск', 'Барнаул', 'Иркутск', 'Кемерово',
      'Томск', 'Новокузнецк', 'Улан-Удэ', 'Чита', 'Абакан', 'Кызыл',
      
      // Дальневосточный ФО
      'Хабаровск', 'Владивосток', 'Благовещенск', 'Магадан', 'Южно-Сахалинск',
      'Петропавловск-Камчатский', 'Якутск', 'Анадырь', 'Биробиджан',
      
      // Московская область
      'Подольск', 'Балашиха', 'Химки', 'Королёв', 'Мытищи', 'Люберцы',
      'Электросталь', 'Коломна', 'Одинцово', 'Серпухов', 'Щёлково',
      'Орехово-Зуево', 'Ногинск', 'Жуковский', 'Дубна', 'Пушкино',
      
      // Ленинградская область
      'Гатчина', 'Выборг', 'Сосновый Бор', 'Тихвин', 'Кингисепп', 'Волхов'
    ];
  ...
  getDistanceBetweenCities(from, to) {
    ...
    if (fromNormalized !== 'Москва' && toNormalized !== 'Москва') {
      const fromToMoscow = DISTANCE_DATABASE[fromNormalized]?.['Москва'] || 
                          DISTANCE_DATABASE['Москва']?.[fromNormalized];
      const moscowToTo = DISTANCE_DATABASE['Москва']?.[toNormalized] || 
                        DISTANCE_DATABASE[toNormalized]?.['Москва'];
